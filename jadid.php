<?php
define('API_KEY',"5199956868:AAH3yiPby1goZKTooKpQvZ5t4-67FkjcDzw"); //<====== بجای کلمه توکن توکن ربات خود را قرار دهید
$Dev = 5059280908; // <==== آیدی عددی مدیر ربات
$userbot = "Hamekarehbot"; //<=== نام کاربری ربات
$userchanel = "acharfaran30"; //<==== آی دی کاتال
/*
آیدی کانال را بدون 
@
وارد کنید
...
elseif($textmassage == "/start" && $tc == "private"){
    ...
    Poker('SendMessage',[
        'chat_id'=>$chat_id,
        'text'=>"😼👾به ربات اد کن طلائی خوش آمدید
